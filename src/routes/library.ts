...
import * as author_controller from "../controllers/library/author";
import * as book_controller from "../controllers/library/book";
import * as bookinstance_controller from "../controllers/library/bookInstance";
import * as genre_controller from "../controllers/library/genre";
...
router.post("/book/create", book_controller.book.create_post);
